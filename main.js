...
function reset() {
    ...
    gamedata.totalCPS = 0;
    gamedata.CPCcost = 10;
    gamedata.codepersec = 0;
    gamedata.CPScost = 100;
    gamedata.pcost = 1000;
    gamedata.pCPS = 0;
    gamedata.compcost = 10000;
    gamedata.compCPS = 0;
    gamedata.corpcost = 100000;
    gamedata.corpCPS = 0;
    gamedata.times2cost = 100000;
    ...
    // hide all elements that aren't meant to be shown
    var upgrades = document.getElementById("upgrades");
